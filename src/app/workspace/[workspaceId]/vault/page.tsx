...
export default async function VaultPage({ params }: PageProps<'/workspace/[workspaceId]/vault'>) {
  ...
  return <VaultView workspaceId={workspaceId} canEdit={workspace.canEdit} canShare={workspace.canShare} canManageAccess={workspace.canManageAccess} isOwner={workspace.role === 'owner'} />;
}
